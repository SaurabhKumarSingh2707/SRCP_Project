...
import { User, Mail, Building, FileText, Save, CheckCircle, Camera, Link as LinkIcon, Phone, Plus, Trash2, Calendar, Hash, Users } from 'lucide-react';
            ...
            <Card className="p-6">
                ...
                <form onSubmit={handleSubmit} className="space-y-8">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        {isFaculty && (
                            <>
                                <div><label className="block text-sm font-medium text-slate-700 mb-1">Employee ID (Read Only)</label><input type="text" name="employeeId" value={profileData.employeeId} disabled className="block w-full px-3 py-2 border border-slate-200 rounded-lg bg-slate-50 text-slate-500 sm:text-sm cursor-not-allowed" /></div>
